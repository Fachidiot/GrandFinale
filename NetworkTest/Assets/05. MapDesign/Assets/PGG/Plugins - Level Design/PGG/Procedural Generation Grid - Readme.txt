...
Beta Version 1.6.6.2.12:
- When Cell Instruction Command (like doorway commands) had disabled spawner, the next spawners was not called: fixed
- Added Command Dir vs Rotation (Corner Doorway Check) Field Planner Node

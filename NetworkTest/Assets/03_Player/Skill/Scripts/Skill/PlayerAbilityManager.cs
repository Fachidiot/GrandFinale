    ...
    private void ApplyCompositeStat(AbilityData ability)
    {
        switch (ability.param_Key)
        {
            ...
            case "SAS_Module":
                ...
                playerStats.AddStatPercent("MoveSpeed", 5f); // 5% ����
                break;
            ...
            case "Bulwark_Armor":
                ...
                playerStats.AddStatPercent("MoveSpeed", -15f); // 15% ����
                break;

            default:
                Debug.LogWarning($"[ApplyCompositeStat] ���ǵ��� ���� param_Key: {ability.param_Key}");
                break;
        }
    }
